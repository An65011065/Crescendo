                ...
                <div className="grid md:grid-cols-2 gap-12 mb-12">
                    <div>
                        ...
                        <p className="text-xl text-gray-400 leading-relaxed mb-6">
                            A Senior Seminar project at Middlebury College
                            exploring the intersection of music, location, and
                            social discovery.
                        </p>
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        <div>
                            <h3 className="text-sm font-bold tracking-widest text-orange-500 mb-4">
                                PROJECT
                            </h3>
                ...
                <div className="border-t border-gray-800 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-gray-500 text-sm">
                            © 2025 Crescendo. Built with React, Vite, and
                            Tailwind CSS.
                        </p>
                        <p className="text-gray-500 text-sm">
